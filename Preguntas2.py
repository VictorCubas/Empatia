...
#-----------------------------------------------------------------------------------------------
# Calcula el puntaje del jugador con respecto a la respuesta a la pregunta y la correspondiente
# consecuencia en el Hud con la variable estadoBarra
#-----------------------------------------------------------------------------------------------
    def calcularPuntaje(self,respuesta):
        estadoBarra = 0
        if respuesta == self.parser.get('Pregunta' + str(self.numeroPregunta), 'respuesta'):
            self.puntaje = self.puntaje + random.randint(1,5)
            print estadoBarra
            estadoBarra = estadoBarra + random.randint(1,5)
            print estadoBarra
        elif respuesta == self.parser.get('Pregunta' + str(self.numeroPregunta), 'opcion4'):
            self.puntaje = self.puntaje - randint(1,3)
            print self.puntaje
            estadoBarra = random.randint(1,3)
            print estadoBarra
        else:
            self.puntaje = self.puntaje + random.randint(1,3)
            estadoBarra = random.randint(1,3)
